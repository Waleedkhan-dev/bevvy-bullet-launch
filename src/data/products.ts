...
export const products: Product[] = [
  {
    ...
    shortDescription: "Gold Edition - First 100 backers only. Lock in Founder Pricing ($41).",
    images: ["/placeholder.svg"],
    category: "founders",
    badge: "FOUNDERS - LIMITED 100",
    inStock: true,
    rating: 5,
    reviewCount: 0,
    features: [
  ...
  },
  {
    ...
    shortDescription: "3 Gold Founders Editions - Best value. Limited to first 100.",
    images: ["/placeholder.svg"],
    category: "founders",
